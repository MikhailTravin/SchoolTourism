 ...
 */        !function(e, t) {
        ...
        const inputStudentsQuantity_1 = document.querySelector("#quantity-1");
        const inputStudentsQuantity_2 = document.querySelector("#quantity-2");
        ...
        const numberStudentsPrice_2 = document.querySelector(".it-price-students-medium");
        const numberStudentsPrice_3 = document.querySelector(".it-price-students-big");
        const numberStudentsPriceWeekend = document.querySelector(".it-price-students-weekend");
        const numberStudentsPriceFive = document.querySelector(".it-price-students-five");
        const numberDescStudentsPrice = document.querySelectorAll(".desc-price-students-small");
        const numberDescStudentsPrice_2 = document.querySelectorAll(".desc-price-students-medium");
        const numberDescStudentsPrice_3 = document.querySelectorAll(".desc-price-students-big");
        const numberAttendantsPrice = document.querySelector(".it-price-attendants-small");
        const numberAttendantsPrice_2 = document.querySelector(".it-price-attendants-medium");
        const numberAttendantsPrice_3 = document.querySelector(".it-price-attendants-big");
        const numberAttendantsPriceWeekend = document.querySelector(".it-price-attendants-weekend");
        const numberAttendantsPriceFive = document.querySelector(".it-price-attendants-five");
        const numberAttendants = document.querySelector(".number-attendants-small");
        const numberAttendants_2 = document.querySelector(".number-attendants-medium");
        const numberAttendants_3 = document.querySelector(".number-attendants-big");
        const numberOptionsPriceWeekend = document.querySelector(".it-price-options-weekend");
        const numberOptionsPriceFive = document.querySelector(".it-price-options-five");
        ...
        const totalPrice_2 = document.querySelectorAll(".price-tour-card__total-sum");
        const totalPriceOld = document.querySelector(".form-popup__total-old-price");
        ...
        function calculater() {
            ...
            if (inputStudentsMasterСlass) {
                ...
                if (value > maxStudentsMasterСlass) inputStudentsMasterСlass.value = maxStudentsMasterСlass; else if (value < minStudentsMasterСlass) inputStudentsMasterСlass.value = minStudentsMasterСlass;
            }
            inputNumberStudents.addEventListener("input", (function(e) {
                ...
                if (value > maxStudents) inputNumberStudents.value = maxStudents; else if (value < minStudents) inputNumberStudents.value = minStudents;
            ...
            if (numberStudentsPrice.classList.contains("_active")) {
                totalPriceElement += inputNumberStudents.value * numberStudentsPrice.innerHTML;
                totalPriceElement_2 += inputNumberStudents.value * numberStudentsPrice.innerHTML;
                ...
                if (inputNumberAttendants.value > numberAttendants.innerHTML) totalPriceElement = totalPriceElement + inputNumberAttendants.value * numberAttendantsPrice.innerHTML - numberAttendantsPrice.innerHTML * numberAttendants.innerHTML;
            }
            if (numberStudentsPrice_2.classList.contains("_active")) {
                totalPriceElement += inputNumberStudents.value * numberStudentsPrice_2.innerHTML;
                totalPriceElement_2 += inputNumberStudents.value * numberStudentsPrice_2.innerHTML;
                radioType_2.forEach((radio_2 => {
                    if (true === radio_2.checked) {
                        radioType_1.value = 0;
                        if (true === radioType_1.checked) {
                ...
                if (inputNumberAttendants.value > numberAttendants_2.innerHTML) totalPriceElement = totalPriceElement + inputNumberAttendants.value * numberAttendantsPrice_2.innerHTML - numberAttendantsPrice_2.innerHTML * numberAttendants_2.innerHTML;
            }
            if (numberStudentsPrice_3.classList.contains("_active")) {
                totalPriceElement += inputNumberStudents.value * numberStudentsPrice_3.innerHTML;
                totalPriceElement_2 += inputNumberStudents.value * numberStudentsPrice_3.innerHTML;
                radioType_2.forEach((radio_2 => {
                    if (true === radio_2.checked) {
                        radioType_1.value = 0;
                        if (true === radioType_1.checked) {
                ...
                if (inputNumberAttendants.value > numberAttendants_3.innerHTML) totalPriceElement = totalPriceElement + inputNumberAttendants.value * numberAttendantsPrice_3.innerHTML - numberAttendantsPrice_3.innerHTML * numberAttendants_3.innerHTML;
            }
            quantityButtons.forEach((quantityButton => {
                quantityButton.addEventListener("click", (function(e) {
                    ...
                    if (quantityButton.classList.contains("quantity__button_plus")) {
                        value++;
                        if (value >= 50) quantityButton.classList.add("disabled"); else quantityButton.classList.remove("disabled");
                    } else {
                        value -= 1;
                        if (value < 1) {
                            value = 1;
                            quantityButton.classList.add("disabled");
                        } else quantityButton.classList.remove("disabled");
                    }
            ...
            if (optionsOther) radioType_2.forEach((radio_2 => {
                if (true === radio_2.checked) {
                    radioType_1.value = 0;
                    if (true === radioType_1.checked) document.documentElement.classList.add("_active-option"); else document.documentElement.classList.remove("_active-option");
                }
            }));
            radioType.forEach((radio => {
                if (true === radio.checked) totalPriceElement += parseInt(radio.value);
            }));
            if (parseInt(inputStudentsMasterСlass.value) > inputNumberStudents.value) inputNumberStudents.value = inputStudentsMasterСlass.value;
            ...
            document.querySelectorAll(".cell_wrapper").forEach((cell => {
                if (cell) cell.addEventListener("click", (function(e) {
                    ...
                    if (calendarItemFifth) {
                        ...
                        if (inputNumberAttendants.value > numberAttendants.innerHTML) totalPriceElement = totalPriceElement + inputNumberAttendants.value * priceAttendants - numberAttendantsPrice.innerHTML * priceAttendants - numberAttendantsPrice.innerHTML;
                        ...
                        if (inputNumberAttendants.value > numberAttendants_2.innerHTML) totalPriceElement = totalPriceElement + inputNumberAttendants.value * numberAttendantsPrice_2.innerHTML - priceAttendants_2;
                        ...
                        if (inputNumberAttendants.value > numberAttendants_3.innerHTML) totalPriceElement = totalPriceElement + inputNumberAttendants.value * numberAttendantsPrice_3.innerHTML - priceAttendants_3;
                        radioType_2.forEach((radio_2 => {
                            if (true === radio_2.checked) radioType_2.value = radioType_2.value + numberOptionsPriceWeekend.innerHTML;
                        }));
                    } else {
                    ...
                    if (calendarItemsSixth) {
                        ...
                        if (inputNumberAttendants.value > numberAttendants_3.innerHTML) totalPriceElement = totalPriceElement + inputNumberAttendants.value * numberAttendantsPrice_3.innerHTML - priceAttendants_3;
                        radioType_2.forEach((radio_2 => {
                            if (true === radio_2.checked) radioType_2.value = radioType_2.value + numberOptionsPriceFive.innerHTML;
                        }));
                    } else document.documentElement.classList.remove("_active-weekend");
                }));
            }));
            const formatter = new Intl.NumberFormat("ru");
            if (totalPrice) totalPrice.innerText = formatter.format(totalPriceElement);
            if (totalPrice_2) totalPrice_2.forEach((total => {
                total.innerText = formatter.format(totalPriceElement_2);
            }));
            if (totalPriceOld) totalPriceOld.innerText = totalPriceElement + totalPriceElement / 100 * percent;
        }
        calculater();
        document.querySelectorAll(".cell_wrapper").forEach((cell => {
